<template>
      ...
      <body>
        <div class='enc'>
          <center><img class="foto" src="../assets/logo.png" height="90px"></center>
          <h1 class='pie'>El Buen Sabor</h1>
          <header class='hea'>
              <nav class='na'>
    ...
    <header id="header" class="header">
        ...
        <div id="lista-cursos" class="container">
          <h1 id="encabezado" class="encabezado">¡Disfruta el Buen Sabor de Mi Tierra!</h1>
          <h3>Desayunos</h3>
          <div class="row">
              <div class="four columns">
                  <div class="card">
                      <img src="../assets/caldo-con-huevo.jpg" class="imagen-curso u-full-width">
                      <div class="info-card">
                          <h4>Caldo con Huevo</h4>
                          <p class="precio"><span class="u-pull-right ">$6000</span></p>
              ...
              <div class="four columns">
                      <div class="card">
                          <img src="../assets/caldo-costilla-cerca-pq.jpg"  class="imagen-curso u-full-width">
                          <div class="info-card">
                              <h4>Caldo de Costilla</h4>
                              <p class="precio"><span class="u-pull-right ">$8000</span></p>
              ...
              <div class="four columns">
                      <div class="card">
                          <img src="../assets/caldo-cabeza-bagre.jpg" class="imagen-curso u-full-width">
                          <div class="info-card">
                              <h4>Caldo de Cabeza de bagre</h4>
                              <p class="precio"><span class="u-pull-right ">$12000</span></p>
          ...
          <div class="row">
              <div class="four columns">
                  <div class="card">
                      <img src="../assets/chanfaina-foto-principal.jpg" class="imagen-curso u-full-width">
                      <div class="info-card">
                          <h4>Chanfaina</h4>
                          <p class="precio"><span class="u-pull-right ">$10000</span></p>
              ...
              <div class="four columns">
                      <div class="card">
                          <img src="../assets/caldo-pata.jpg" class="imagen-curso u-full-width">
                          <div class="info-card">
                              <h4>Caldo de Pata</h4>
                              <p class="precio"><span class="u-pull-right ">$12000</span></p>
              ...
              <div class="four columns">
                      <div class="card">
                          <img src="../assets/tamal-santandereano.jpg" class="imagen-curso u-full-width">
                          <div class="info-card">
                              <h4>Tamal Santandereano</h4>
                              <p class="precio"><span class="u-pull-right ">$5000</span></p>
          ...
          <div class="row">
            <div class="four columns">
                <div class="card">
                    <img src="../assets/tamal-tolimense.jpg" class="imagen-curso u-full-width">
                    <div class="info-card">
                        <h4>Tamal Tolimense</h4>
                        <p class="precio"><span class="u-pull-right ">$6000</span></p>
                        <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="1">Agregar Al Carrito</a>
                    </div>
                </div> <!--.card-->
          ...
          <div class="row">
              <div class="four columns">
                  <div class="card">
                      <img src="../assets/pechuga.jpg" class="imagen-curso u-full-width">
                      <div class="info-card">
                ...
                <div class="four columns">
                    <div class="card">
                        <img src="../assets/Carne-plancha.jpg" class="imagen-curso u-full-width">
                        <div class="info-card">
                            <h4>Carne a la Plancha</h4>
                            <p class="precio"><span class="u-pull-right ">$10000</span></p>
                ...
                <div class="four columns">
                    <div class="card">
                        <img src="../assets/carne-sudada.jpg" class="imagen-curso u-full-width">
                        <div class="info-card">
                            <h4>Carne Sudada</h4>
                            <p class="precio"><span class="u-pull-right ">$10000</span></p>
                ...
                <div class="row">
                  <div class="four columns">
                      <div class="card">
                          <img src="../assets/albondigas.jpg" class="imagen-curso u-full-width">
                          <div class="info-card">
                              <h4>Albóndigas</h4>
                              <p class="precio"><span class="u-pull-right ">$10000</span></p>
                              <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="7">Agregar Al Carrito</a>
                    ...
                    <div class="four columns">
                        <div class="card">
                            <img src="../assets/mute-santandereano.jpg" class="imagen-curso u-full-width">
                            <div class="info-card">
                                <h4>Mute Santandereano</h4>
                                <p class="precio"><span class="u-pull-right ">$12000</span></p>
                                <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="8">Agregar Al Carrito</a>
                            </div>
                        </div> <!--.card-->
                    ...
                    <div class="four columns">
                        <div class="card">
                            <img src="../assets/pernil-sudado.jpg" class="imagen-curso u-full-width">
                            <div class="info-card">
                                <h4>Pernil Sudado</h4>
                                <p class="precio"><span class="u-pull-right ">$12000</span></p>
                                <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="9">Agregar Al Carrito</a>
              ...
              <div class="four columns">
                      <div class="card">
                          <img src="../assets/arroz-mixto.jpg" class="imagen-curso u-full-width">
                          <div class="info-card">
                              <h4>Arroz Mixto</h4>
                              <p class="precio"><span class="u-pull-right ">$12000</span></p>
              ...
              <div class="four columns">
                <div class="card">
                    <img src="../assets/lengua-salsa.jpg" class="imagen-curso u-full-width">
                    <div class="info-card">
        ...
        <div class="four columns">
          <div class="card">
              <img src="../assets/bagre-sudado.jpg" class="imagen-curso u-full-width">
              <div class="info-card">
                  <h4>Bagre Sudado</h4>
                  <p class="precio"><span class="u-pull-right ">$17000</span></p>
                  <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="12">Agregar Al Carrito</a>
              </div>
          </div> <!--.card-->
        </div><!--.row-->
      ...
      <div class="row">
            <div class="four columns">
                <div class="card">
                    <img src="../assets/bocachico.jpg" class="imagen-curso u-full-width">
                    <div class="info-card">
                        <h4>Bocachico Frito</h4>
                        <p class="precio"><span class="u-pull-right ">$17000</span></p>
                        <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="1">Agregar Al Carrito</a>
                    </div>
                </div> <!--.card-->
...
<!--cuarta fila--> 
        <h3>Bebidas</h3>
                <div class="row">
                  <div class="four columns">
                          <div class="card">
                              <img src="../assets/cafe-leche.jpg" class="imagen-curso u-full-width">
                              <div class="info-card">
                ...
                <div class="four columns">
                  <div class="card">
                      <img src="../assets/tinto.jpg" class="imagen-curso u-full-width">
                      <div class="info-card">
                          <h4>Tinto</h4>
                          <p class="precio"><span class="u-pull-right ">$1500</span></p>
                          <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="12">Agregar Al Carrito</a>
              ...
              <div class="four columns">
                  <div class="card">
                    <img src="../assets/chocolate.jpg" class="imagen-curso u-full-width">
                      <div class="info-card">
                    <h4>Chocolate</h4>
                    <p class="precio"><span class="u-pull-right ">$1500</span></p>
                    <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="12">Agregar Al Carrito</a>
              ...
              <div class="row">
                <div class="four columns">
                        <div class="card">
                            <img src="../assets/gaseosas.jpg" class="imagen-curso u-full-width">
                            <div class="info-card">
                                <h4>Gaseosas(Hit - Mr Tea)</h4>
                                <p class="precio"><span class="u-pull-right ">$2000</span></p>
                                <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="12">Agregar Al Carrito</a>
                            </div>
                        </div> <!--.card-->
                </div>
              ...
              <div class="four columns">
                <div class="card">
                    <img src="../assets/gaseosa-litro.jpg" class="imagen-curso u-full-width">
                    <div class="info-card">
                        <h4>Gaseosa Litro</h4>
                        <p class="precio"><span class="u-pull-right ">$3500</span></p>
                        <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="12">Agregar Al Carrito</a>
                    </div>
                </div> <!--.card-->
            </div>
            <div class="four columns">
                <div class="card">
                  <img src="../assets/granizado.jpg" class="imagen-curso u-full-width">
                    <div class="info-card">
                  <h4>Granizad de Naranja-Mandarina</h4>
                  <p class="precio"><span class="u-pull-right ">$4500</span></p>
                  <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="12">Agregar Al Carrito</a>
              </div>
            </div> <!--.card-->
            </div><!--.row-->
